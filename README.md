...
- Nama: Muhammad Yusuf
- NIM: 122140193
- Deployment: _(akan diisi setelah rilis Vercel)_

## Gambaran Proyek
Aplikasi React ini mengubah studi kasus Pokédex menjadi katalog resep berbasis API TheMealDB. Seluruh halaman, komponen, dan state management sudah disesuaikan dengan rubrik UTS Pemrograman Web sehingga poin CPMK0501 dan CPMK0502 dapat terpenuhi.
...
## Cara Menjalankan
1. **Persiapan lingkungan**: Node.js >= 18 (npm atau bun).
2. **Instal dependensi**
   ```bash
   npm install
   # atau
...
---
Dokumentasi ini sengaja ringkas dan to the point supaya mudah difahami saat proses asistensi maupun koreksi.
